...
function P1Accessory (platform, name, data) {
  ...
  if (data.l1 != null && data.l2 != null && data.l3 != null) {
    // Three-phase electricity: add service per phase.
    this.serviceL1 = new my.Services.Resource(this.name + ' L1', 'L1')
    this.serviceList.push(this.serviceL1)
    this.p1ServiceL1 = new P1Service(this.platform, this.serviceL1, data.l1)

    this.serviceL2 = new my.Services.Resource(this.name + ' L2', 'L2')
    this.serviceList.push(this.serviceL2)
    this.p1ServiceL2 = new P1Service(this.platform, this.serviceL2, data.l2)

    this.serviceL3 = new my.Services.Resource(this.name + ' L3', 'L3')
    this.serviceList.push(this.serviceL3)
    this.p1ServiceL3 = new P1Service(this.platform, this.serviceL3, data.l3)
  } else if (data.l1 != null) {
    // Single-phase electricity: add phase characteristics to main service.
