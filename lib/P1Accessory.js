...
function P1Accessory (platform, name, data) {
  ...
  if (
    data.l1 != null && data.l1.voltage != null && // data.l1.voltage !== 0 &&
    data.l2 != null && data.l2.voltage != null && // data.l2.voltage !== 0 &&
    data.l3 != null && data.l3.voltage != null // && data.l3.voltage !== 0
  ) {
