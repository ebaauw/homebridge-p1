...
P1Accessory.prototype.handleTelegram = function (telegram) {
  this.service
    .updateCharacteristic(eve.Characteristic.CurrentConsumption, telegram.power)
    .updateCharacteristic(eve.Characteristic.TotalConsumption, telegram.consumption)
    .updateCharacteristic(my.Characteristic.LastUpdated, telegram.lastupdated)
    .updateCharacteristic(eve.Characteristic.ElectricalCurrent, telegram.current)
    .updateCharacteristic(eve.Characteristic.Voltage, telegram.voltage)
