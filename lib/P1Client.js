...
// !
// `
// const telegramv42 = `/KFM5KAIFA-METER
//
// 1-3:0.2.8(42)
// 0-0:1.0.0(190228205019W)
// 0-0:96.1.1(4530303235303030303737373730303136)
// 1-0:1.8.1(005945.778*kWh)
// 1-0:1.8.2(004415.532*kWh)
// 1-0:2.8.1(000212.801*kWh)
// 1-0:2.8.2(000636.089*kWh)
// 0-0:96.14.0(0002)
// 1-0:1.7.0(02.992*kW)
// 1-0:2.7.0(00.000*kW)
// 0-0:96.7.21(00001)
// 0-0:96.7.9(00001)
// 1-0:99.97.0(2)(0-0:96.7.19)(180824143702S)(0000005600*s)(000101000001W)(2147483647*s)
// 1-0:32.32.0(00000)
// 1-0:32.36.0(00000)
// 0-0:96.13.1()
// 0-0:96.13.0()
// 1-0:31.7.0(012*A)
// 1-0:21.7.0(02.992*kW)
// 1-0:22.7.0(00.000*kW)
// 0-2:24.1.0(003)
// 0-2:96.1.0(4730303139333430333231323232383136)
// 0-2:24.2.1(190228200000W)(03514.244*m3)
// !4983
// `
//
  ...
  async findPort (path) {
    return new Promise((resolve, reject) => {
      SerialPort.list().then((ports) => {
        ...
        reject(new Error(`${path}: port not found`))
      })
    })
  }

  async connect (path, dsmr22 = false) {
    ...
    return this.findPort(path).then((port) => {
      return new Promise((resolve, reject) => {
        const p1 = new SerialPort(port.path, options, (error) => {
          if (error) {
            return reject(new Error(`${port.path}: cannot open`))
          }
