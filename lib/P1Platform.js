...
class P1Platform extends Platform {
  ...
  async initWsClient () {
    this.warn(
      'config.json: host: the web socket relay feature will be removed in Homebridge P1 v2, see https://github.com/ebaauw/homebridge-p1/issues/83'
    )
  ...
  async initWsServer () {
    this.warn(
      'config.json: wsPort: the web socket relay feature will be removed in Homebridge P1 v2, see https://github.com/ebaauw/homebridge-p1/issues/83'
    )
